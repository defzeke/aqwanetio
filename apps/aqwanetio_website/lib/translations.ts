...
const dict = {
  en: {
    ...
    modal: {
      ...
      safe: "Safe",
      critical: "Critical",
      criticalLine: "Critical {value} ppm",
    ...
    auth: {
      ...
      phoneInvalid: "Please enter a valid Philippine phone number",
  ...
  fil: {
    ...
    modal: {
      ...
      safe: "Ligtas",
      critical: "Kritikal",
      criticalLine: "Kritikal {value} ppm",
      forecastLegend: "Pagtataya",
      live: "Live",
      historicalData: "Makasaysayang Datos",
    ...
    auth: {
      ...
      passwordMinLength: "Dapat ay hindi bababa sa 8 character ang password",
      phoneNumber: "Numero ng Telepono",
      phonePlaceholder: "+63 9XX XXX XXXX",
      phoneInvalid: "Maglagay ng wastong numero ng telepono sa Pilipinas",
