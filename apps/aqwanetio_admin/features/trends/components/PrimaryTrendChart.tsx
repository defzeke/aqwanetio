export default function PrimaryTrendChart() {
  return (
    <section className="lg:col-span-8 min-w-0 bg-admin-surface border border-admin-border rounded-sm flex flex-col items-start p-6 min-h-[420px]">
      <div className="pb-6 w-full">
        <div className="flex flex-wrap gap-2 items-start justify-between">
          <div className="flex flex-col gap-1">
            <div className="flex gap-2 items-center">
              <h2 className="text-[20px] font-semibold text-admin-text">Primary Trend Component</h2>
              <span className="bg-admin-nav-active rounded-sm px-2 py-0.5 text-[10px] text-admin-text-muted">84.1% VARIANCE</span>
            </div>
          ...
          <div className="flex gap-4 items-center">
            <div className="flex gap-2 items-center">
              ...
              <span className="text-[12px] text-admin-text-secondary">Actual</span>
            </div>
            <div className="flex gap-2 items-center">
              <div className="w-3 h-1 rounded-full bg-admin-green" />
              <span className="text-[12px] text-admin-text-secondary">7D MA</span>
            </div>
          </div>
        </div>
      </div>
      <div className="flex w-full gap-2">
        <div className="flex flex-col justify-between py-2 text-right text-[10px] text-admin-text-secondary w-6 h-[480px] shrink-0">
          <span>20t</span>
          <span>15t</span>
          <span>10t</span>
          <span>5t</span>
        ...
        <div className="flex-1 relative border border-admin-border rounded-sm h-[480px] bg-[repeating-linear-gradient(180deg,#f1f5f9_0,#f1f5f9_1px,transparent_1px,transparent_96px),repeating-linear-gradient(90deg,#f1f5f9_0,#f1f5f9_1px,transparent_1px,transparent_96px)]">
          ...
          <div className="absolute left-[62%] top-24 bg-admin-text border border-white/20 rounded-sm p-3 shadow-lg">
      ...
      <div className="flex items-start justify-between w-full mt-1 text-[10px] text-admin-text-secondary">
        <span>NOV 14</span>
        <span>NOV 21</span>
        <span>NOV 28</span>
        <span>DEC 05</span>
